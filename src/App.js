...
const initialState = {
  nodes: [
      {id: 0, type: "sticky_note", x: window.innerWidth/12, y: window.innerHeight/10, width: 150, height: 120, selected: false, text: "", display: true},
      {id: 1, type: "sticky_note", x: window.innerWidth/12+2, y: window.innerHeight/10+2, width: 150, height: 120, selected: false, text: "", display: true},
      {id: 2, type: "sticky_note", x: window.innerWidth/12+4, y: window.innerHeight/10+4, width: 150, height: 120, selected: false, text: "", display: true},
      {id: 3, type: "sticky_note", x: window.innerWidth/12+6, y: window.innerHeight/10+6, width: 150, height: 120, selected: false, text: "", display: true},
      {id: 4, type: "sticky_note", x: window.innerWidth/12+8, y: window.innerHeight/10+8, width: 150, height: 120, selected: false, text: "", display: true}
  ],
  num_nodes: 5,
  prompt_cards: [
  ...
  return (
    <div className="container fullscreen" id="fullsccreen">
      <GlobalContext.Provider value={{
        nodes, numNodes, promptCards, mainPrompter,
        setNodes, setNumNodes, setPromptCards, setMainPrompter
      }}>
        <Canvas />
