...
function App() {
  ...
  const initialState = {
    ...
    task_nodes: [
      ...
      // {node_id: 1, task_id: 1, attached_to_id: 0, type: "sticky_note", x: 1000, y: 250, width: 145, height: 110, fontSize: 18, text: "This is a very long text from task 1. very very long"},
