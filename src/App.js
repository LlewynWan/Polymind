...
function App() {
  ...
  const initialState = {
    ...
    task_nodes: [
      {id: 0, node_id: 0, task_id: 0, attached_to_id: 0, type: "keyword", x: 500, y: 250, fontSize: 20, text: "task1", display: false},
      {id: 1, node_id: 1, task_id: 1, attached_to_id: 0, type: "sticky_note", x: 1000, y: 250, width: 145, height: 110, fontSize: 18, text: "This is a very long text from task 2. very very long", display: false},
      {id: 2, node_id: 2, task_id: 2, attached_to_id: 0, type: "concept", x: 1000, y: 250, radiusX: 72, radiusY: 40, fontSize: 20, text: "a concept", display: false}
    ],
    task_arrows: [
